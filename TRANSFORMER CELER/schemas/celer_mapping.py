...
COLUMN_DESCRIPTIONS: Dict[OutputColumn, str] = {
    OutputColumn.A: "Generated/Calculated field - Sequential ID or derived value",
    OutputColumn.B: "Días - Days pending from Celer",
    OutputColumn.C: "Tomador - Policyholder name",
    OutputColumn.D: "Tipo_Doc - Document type (C.C., NIT, etc.)",
    OutputColumn.E: "Identificacion - ID number",
    OutputColumn.F: "Poliza - Policy number",
    OutputColumn.G: "Documento - Document/receipt number",
    OutputColumn.H: "Cuota - Installment/quota number",
    OutputColumn.I: "Placa - Vehicle license plate",
    OutputColumn.J: "Saldo - Outstanding balance",
    OutputColumn.K: "Aseguradora - Insurance company name",
    OutputColumn.L: "Ramo - Insurance line/branch",
    OutputColumn.M: "Carta_Cobro - Collection letter reference",
    OutputColumn.N: "F_Inicio - Start date",
    OutputColumn.O: "F_Expedicion - Issue date",
    OutputColumn.P: "F_Creacion - Creation date",
    OutputColumn.Q: "Ejecutivo - Account executive name",
    OutputColumn.R: "Unidad - Business unit",
    OutputColumn.S: "Descripcion_Riesgo - Risk description",
    OutputColumn.T: "Celular_Pers - Personal cell phone",
    OutputColumn.U: "Celular_Lab - Work cell phone",
    OutputColumn.V: "Mail_Lab - Work email",
    OutputColumn.W: "Mail_Pers - Personal email",
}
